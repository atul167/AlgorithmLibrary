...
// Function to print contiguous subarray with the largest sum in a given set of integers
void kadane() {
    ...
    cout << "The sum of contiguous subarray with the largest sum is " << max_so_far << endl;
